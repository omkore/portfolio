...
// const el1 = React.useRef(null);
  ...
  React.useEffect(() => {
    const typed = new Typed(el.current, {
      strings: ['Web Developer.','Designer.', 'Gamer.','Editor.'],
      typeSpeed: 80,
      backSpeed:50,
      loop:true,
    });
    // const typed1 = new Typed(el1.current, {
    //   strings: [' Hi',' namaste', ' Hola',' Bonjour',' konnichiwa',' annyeong',' ciao',' Ola'],
    //   typeSpeed: 80,
    //   backSpeed:50,
    //   loop:true,
    // });
  ...
  return (
    <div className='home__data'>
        ...
        <p className="home__description">from Solapur, India. <br/>I'm passionate and dedicated to my work, and desired to <b>Learn</b> and <b>Explore</b> Technology</p>
        <motion.div className='hi-btn' ref={constraintsRef}>
          <motion.a  
            drag

            dragConstraints={constraintsRef} href="#contact" className="button button--flex ">
               Say Hi
              <svg
                    class="button__icon"
                    xmlns="http://www.w3.org/2000/svg"
